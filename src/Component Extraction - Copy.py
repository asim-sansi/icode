...
class HTMLComponent:
    ...
    def Code(self):
        code = "<" +\
               ...
               " left:" + str(self.x) + "px;" +\
               " width:" + str(self.w) + "px;" +\
               " height:" + str(self.h) + "px;" +\
               " text-align:" + "center;" +\
               " color:" + str(self.styles['color']) + ";" +\
               " background-color:" + str(self.styles['background-color']) + "'>TEXT</div>\n"
               # " SRC='" + self.path + "'>"
        return code
...
class TEXT(HTMLComponent):
    ...
    def Code(self):
        ...
        code = "<" + \
               ...
               " text-align:" + "center;" + \
               " color:" + str(self.styles['color']) + ";" + \
               " background-color:" + str(self.styles['background-color']) + "'>"+self.translateText()+"</div>\n"
        # " SRC='" + self.path + "'>"
        return code
